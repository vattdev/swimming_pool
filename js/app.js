    ...
    (() => {
        ...
        function formRating() {
            ...
            function initRatings() {
                let ratingActive, ratingValue, selectedRatingText, selectedRatingValue;
                ...
                function initRating(rating) {
                    ...
                    setRatingActiveWidth(selectedRatingValue);
                    if (rating.classList.contains("rating_set")) setRating(rating);
                }
                function initRatingVars(rating) {
                    ratingActive = rating.querySelector(".rating__active");
                    ratingValue = rating.querySelector(".rating__value");
                    selectedRatingText = ratingValue.innerHTML;
                    selectedRatingValue = 0;
                }
                function setRatingActiveWidth(value = selectedRatingValue) {
                    const ratingActiveWidth = value / 5 * 100;
                ...
                function setRating(rating) {
                    ...
                    for (let index = 0; index < ratingItems.length; index++) {
                        ...
                        ratingItem.addEventListener("mouseenter", (function() {
                            ...
                            ratingValue.innerHTML = ratingItem.dataset.rating;
                        }));
                        ratingItem.addEventListener("mouseleave", (function() {
                            setRatingActiveWidth();
                            ratingValue.innerHTML = selectedRatingText;
                        }));
                        ratingItem.addEventListener("click", (function() {
                            selectedRatingValue = ratingItem.value;
                            selectedRatingText = ratingItem.dataset.rating;
                            ratingValue.innerHTML = selectedRatingText;
                            setRatingActiveWidth();
                        }));
                    }
        ...
        function initSliders() {
            if (document.querySelector(".section-news__slider")) {
                new swiper_core_Swiper(".section-news__slider", {
                ...
                new swiper_core_Swiper(".section-team__slider", {
                    modules: [ Navigation ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 3,
            ...
            if (document.querySelector(".section-swim__slider")) new swiper_core_Swiper(".section-swim__slider", {
                ...
                speed: 800,
                pagination: {
                    el: ".swiper-pagination-swim",
                    clickable: true
                },
                navigation: {
                    prevEl: ".swiper-button-prev-swim",
                    nextEl: ".swiper-button-next-swim"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1,
            ...
            if (document.querySelector(".section-swim__slider-tennis")) new swiper_core_Swiper(".section-swim__slider-tennis", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
...
***************************************************************************** */
        ...
        da.init();
        if (document.querySelector(".section-main__video")) document.addEventListener("scroll", (function() {
            const parallaxVideo = document.querySelector(".section-main__video");
            const offset = window.pageYOffset;
            parallaxVideo.style.transform = `translateY(${offset * .8}px)`;
        }));
        if (document.querySelector("#map")) {
            ymaps.ready(init);
            function init() {
                var latitude = 45.049165;
                var longitude = 41.975365;
